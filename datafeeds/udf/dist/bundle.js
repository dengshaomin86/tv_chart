    ...
    var HistoryProvider = /** @class */ (function () {
        ...
        HistoryProvider.prototype.getBars = function (symbolInfo, resolution, rangeStartDate, rangeEndDate) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this._requester.sendRequest('https://www.ufo.club/chart/kline/period?step=' + step + '&sid=0c8aa717&symbol=2&nonce=1527940994880')
                    .then(function (response) {

                        response = dealData(response);
        ...
        UDFCompatibleDatafeedBase.prototype.onReady = function (callback) {
            ...
            this._configurationReadyPromise.then(function () {
                ...
                var cb_config = {
                    ...
                    "symbols_types": [     //品种所属类型
                        // {"name": "All types", "value": ""},
                        // {"name": "Stock", "value": "stock"},
                        // {"name": "Index", "value": "index"}
                    ],
                    "supported_resolutions": supported_resolutions   //表示支持显示的哪几种图
                };
                        ...
                        .then(function (response) {
                            if (response.s !== undefined) {
                                ...
                                var resp = {
                                    ...
                                    "has_weekly_and_monthly": true,   //支持数周和数月
                                    "has_no_volume": false,
                                    "description": "",
                                    "type": "stock",
